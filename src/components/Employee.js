...
export default function Employee(props) {
  ...
  // ngoài ra có thể truyền props từ main component là từng employee, thông qua việc click vào hình, tuy nhiên bắt phải có event click thì mới chạy được, còn nếu reload loại trang sẽ cho ra trang trắng vì không có load data từ event onClick.
